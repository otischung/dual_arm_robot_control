...
# Left arm angle
DEFAULT_LEFT_JOINT_DEG_ANGLE = [170, 10, 80, 60, 80, 10, 0]
MIN_LEFT_JOINT_DEG_ANGLE = [0, 0, 0, 0, 0, 0, 0]
MAX_LEFT_JOINT_DEG_ANGLE = [180, 180, 180, 180, 180, 180, 0]

# Right arm angle
DEFAULT_RIGHT_JOINT_DEG_ANGLE = [10, 170, 90, 85, 90, 0, 0]
MIN_RIGHT_JOINT_DEG_ANGLE = [0, 90, 0, 0, 0, 0, 0]
MAX_RIGHT_JOINT_DEG_ANGLE = [180, 180, 180, 120, 180, 90, 0]
